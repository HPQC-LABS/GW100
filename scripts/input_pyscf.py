...
neut_mcc = cc.UCCSD(neut_mhf).set(conv_tol=1e-5, frozen=3)  # Post-Hartree-Fock
...
cat_mcc = cc.UCCSD(cat_mhf).set(conv_tol=1e-5, frozen=3)    # Post-Hartree-Fock
cat_tup = cat_mcc.kernel()                                  #
cat_et = neut_mcc.ccsd_t()                                  #
